...
<div class="container">
    ...
    <form action="{{route('imgbanniere.update',$imgbanniere)}}" method="post" enctype="multipart/form-data">
        @csrf
@method('put')
        <div class="form-group text-darka ">
            <label class="h3" for="titre">Titre :</label> <br>
            <input value="{{$imgbanniere->titre}}" type="text" name="titre"
